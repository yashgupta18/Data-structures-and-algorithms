...
int main(){
	...
	rootTwo->left=newNode(2);
	rootTwo->right=newNode(3);
	rootTwo->left->left=newNode(4);
	rootTwo->left->right=newNode(5);
	rootTwo->right->left=newNode(6);
	rootTwo->right->right=newNode(7);
